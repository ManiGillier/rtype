...
#ifndef GAME_GUI_CHAT_HPP
#define GAME_GUI_CHAT_HPP
...
{
public:
    ChatInput(Game &game) : InputBox(), game(game)
    {
        this->x = 0;
        this->y = 700;
        this->width = 350;
    ...
    {
        this->text = this->game.getMessage();
        InputBox::update();
    }
...
{
public:
    ChatSend(Game &game) : Button(), game(game)
    {
        this->x = 350;
        this->y = 700;
        this->width = 50;
...
{
public:
    ChatEntry(Game &game, int id) : TextBox(), game(game), id(id)
    {
        this->x = 10;
        this->height = 35;
    ...
    {
        this->text = this->game.getChatMessage(this->id);
    }
private:
    Game &game;
    int id;
