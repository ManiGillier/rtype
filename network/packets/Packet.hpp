...
enum PacketId {
    S_AUTHENTICATION_PACKET = 0x01,
    C_AUTHENTICATION_PACKET = 0x02,
    AUTHENTIFIED_PACKET = 0x03,
    GAME_START_REQUEST = 0x04,
    LOBBY_CONFIG_PACKET = 0x05,
    NEW_PLAYER = 0x06,
    NEW_ENEMY = 0x07,
    PLAYER_HIT = 0x08,
    HITBOX_SIZE_UPDATE = 0x09,
    GAME_OVER = 0x0A,
    LASER_ACTIVE_UPDATE = 0x0B,
    POSITION_UPDATE = 0x0C,
    CLIENT_INPUTS = 0x0D,
    CREATE_PRIVATE_LOBBY_PACKET = 0x0E,
    DESTROY_ENTITY_PACKET = 0x0F,
    JOINED_LOBBY_PACKET = 0x10,
    JOIN_LOBBY_WITH_CODE_PACKET = 0x11,
    JOIN_OR_CREATE_PUBLIC_LOBBY_PACKET = 0x12,
    SET_ADMIN = 0x13,
    LINK_PLAYERS_PACKET = 0x14,
    LOGIN_PACKET = 0x15,
    LOGIN_RESPONSE_PACKET = 0x16,
    RCON_REQUEST = 0x17,
    RCON_RESPONSE = 0x18,
    REGISTER_PACKET = 0x19,
    SCORE_PACKET = 0x1A,
    SPAWN_STRAIGHT_MOVING_ENTITY_PACKET = 0x1B,
    TEXT_CHAT_STRING_PACKET = 0x1C,
    TIME_NOW_PACKET = 0x1D,
    TEST_PACKET,
};
